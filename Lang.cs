namespace OKTW2
{
    ...
    class Lang
    {
        ...
        public static string onlyComboMode = "Only combo mode";
        public static string autoPlaceWard = "Auto place ward";
        public static string autoPlaceBlueTrinket = "Auto place blue trinket";
        public static string autoVisionWardOracleLens = "Auto VisionWard, OracleLens";

        //Activator

        public static string summonersHeal = "Summoners - Heal";
        public static string heal = "Heal";
        public static string allyHeal = "Ally Heal";
        ...
        public static string glp800 = "GLP800";
        ...
        public static string seraph = "Seraph";
        public static string zhonya = "Zhonya";
        public static string zhonyaSpells = "Zhonya Spells";
        public static string cleansers = "Cleansers";
        public static string cleanseEnable = "Cleanse";
        public static string useOnlyUnderPercentHP = "Use Only Under % HP";
        public static string delayInMs = "Delay in ms";
        public static string buffType = "Buff Type";
        ...
        public static void SetLang(translation LangSet)
        {
            ...
            else if (LangSet == translation.TraditionalChinese)
            {
                ...
                OKTWorbwalker = "OKTW 走砍";
                ORBWALKERMODE = "走砍模式";
                //Spells DRAW and FARM
                spellsDrawAndFarm = "技能顯示及農兵";
                drawSpellRange = "顯示技能範圍";
                drawOnlyReadySpells = "僅顯示可用技能";
                farmToggleMode = "農兵模式開關";
                scrollDown = "滾動滑鼠滾輪";
                scrollPress = "按下滑鼠滾輪";
                keyToggle = "開關熱鍵";
                spellsFarm = "技能農兵";
                importantBuffTimer = "重要增益計時器";
                manaPercent = " 最低魔力 %";
                utilityAndDraws = "功能腳本及顯示";
                //Humanizer
                sbwV2Humanizer = "SBW 人性化 V2";
                enableHumanizer = "啟用人性化點擊";
                blockActionOutScreen = "封鎖畫面外點擊";
                minimumClickTimeMs = "最低點擊時間 毫秒";
                drawActionPerSecond = "顯示每秒活動";
                //BaseUlt
                baseUlt = "基地大招";
                enableBaseUlt = "啟用基地大招";
                enableBaseUltNotification = "啟用基地大招通知";
                disableInComboMode = "連招模式時關閉";
                enemies = "敵人";
                //AutoLeveler
                autoLeveler = "自動升級技能";
                autoLevlerMode = "自動升級模式";
                priority = "優先";
                meta = "主流";
                autoLevelerStart = "在x等級後啟用自動升級技能";
                //Activator
                activator = "活化劑";
                autoWards = "自動插眼";
                onlyComboMode = "僅在連招時";
                autoPlaceWard = "自動插眼";
                autoPlaceBlueTrinket = "自動放藍眼";
                autoVisionWardOracleLens = "自動真眼, 掃眼";
                summonersHeal = "召喚師技能 - 治癒";
                heal = "治癒";
                allyHeal = "治癒友方";
                itemsOffensive = "攻擊類道具";
                botrk = "隕落王者之劍";
                botrkLifeSaver = "使用保命";
                ks = "偷頭";
                combo = "連招";
                cutlass = "比爾吉沃特彎刀";
                hextech = "海克斯科技槍刃";
                protobelt = "海克斯科技腰帶-01";
                glp800 = "海克斯科技 GLP-800";
                yommus = "妖夢鬼刀";
                others = "其他";
                hydra = "狂怒九頭蛇";
                hydraTitanic = "泰坦九頭蛇";
                frostQueen = "霜后宣言";
                itemsDefensives = "防禦類物品";
                consumable = "消耗品";
                faceOfTheMountain = "山靈守護";
                solari = "日輪的加冕";
                randuin = "蘭頓之兆";
                seraph = "熾天使的擁抱";
                zhonya = "中婭沙漏";
                ...
                cleansers = "淨化";
                cleanseEnable = "啟用淨化";
                useOnlyUnderPercentHP = "只在血量低於x%時";
                delayInMs = "延遲 毫秒";
                buffType = "增益類型";
                stun = "暈眩";
                charm = "魅惑";
                ...
                //UtilityAndDraws
                minimap = "小地圖";
                showLastEnemyPosition = "顯示敵人最後位置";
                showPredictedPositionCircles = "顯示預測位置圓圈";
                showLastEnemyDirection = "顯示敵人最後方向";
                uiAvatars = "頭像界面";
                showEnemyAvatars = "顯示敵人頭像";
                bigHdAvatars = "高清頭像";
                positionX = "X方位";
                positionY = "Y方位";
                spellsTracker = "技能追蹤器";
                showSpellsTracker = "顯示技能追蹤器";
                showEnemySpells = "顯示敵方技能";
                showSpellsLevel = "顯示技能等級(降低FPS)";
                showAlliesSpells = "顯示友方技能";
                showMySpells = "顯示我的技能";
                orbitalChampionsRadar = "英雄雷達";
                onlyJungler = "只有打野";
                onlyEnemy = "只有敵人";
                damageIndicators = "傷害指示器";
                showEnemyWards = "顯示敵人偵查守衛";
                showEnemyClicks = "顯示敵人點擊";
                jungleTracker = "打野追蹤器";
                //OKTW AIO 2
                oktwAio2 = "OKTW AIO 2";
                advanced = "進階";
                orbwalker = "走砍";
                disableAutoAttacksInComboAfterLevel = "在x等級後關閉連招時普攻(0等於永遠使用普攻)";
                supportMoade = "輔助模式";
                harrasInLaneClearMode = "清線模式時騷擾";
                mana = "魔力";
                disableManaManagerInCombo = "連招時關閉魔力控制器";
                harrasManaPercent = "騷擾魔力%(-1為自動)";
                masteries = "天賦";
                doubleEdgedSword = "雙面刃 3%";
                merciless = "殘忍 3%";
                onStartDraws = "遊戲開始時顯示";
                oktwLogoOnStart = "顯示OKTW標誌";
                supportedChampionsInfo = "支持英雄資訊";
                other = "其他 (如果遊戲崩潰請關閉)";
                onCreate1 = "OnCreate1 - 進階傷害預測";
                onCreate2 = "OnCreate2 - 進階小地圖偵測";
                onCreate3 = "OnCreate3 - 小地圖漏洞";
                developerOptions = "開發者選項";
                enableConsoleDebug = "啟用除錯視窗";
            }
